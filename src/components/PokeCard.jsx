...
export default function PokeCard(props) {
    ...
    useEffect(() => {
        ...
        // 2. Check if the selectedPokemon is in the cache, otherwise fetch it from the API
        ...
        <div className="poke-card">
            ...
            <div className="img-container">
                {imgList.map((spriteKey, spriteIndex) => {
                    ...
                    return (
                        <img key={spriteIndex} src={spriteUrl} alt={`${name}-img-${spriteKey}`} />
                    )
                })}
            </div>
            <h3>Stats</h3>
